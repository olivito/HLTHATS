...
void plot_trigeff_ht (const TString& infile = "histos_ht_skim.root") {
  ...
  TH1F* h_ht_denom = (TH1F*) f_in->Get("htTrigAnalyzerMiniAOD/h_ht_all");
  ...
  TH2F* h_ht_axis = new TH2F("h_ht_axis",";H_{T} [GeV];Efficiency of HLT_PFHT800",120,0,1200,20,0,1);
